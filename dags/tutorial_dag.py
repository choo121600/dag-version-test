...
with DAG(
    ...
    catchup=False,
    # Owner links for each owner
    owner_links={
        "owner1": "https://mycompany.com/teams/data",
        "owner2": "mailto:analytics@mycompany.com",
        "owner3": "https://mycompany.com/teams/ml"
    },
    # Multiple tags
    tags=["example", "tutorial", "etl", "data_pipeline", "production"],
) as dag:
    # [END instantiate_dag]
    # [START documentation]
    dag.doc_md = __doc__
